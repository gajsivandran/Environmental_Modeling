...
## In-Class Activity — Markov Chains and Daily Energy Levels 
...
## Lab 6 — Modeling Mosquito Population Dynamics with Markov Chains
...
represent the number of individuals in each stage — **Egg, Larva, Pupa, Adult, Dead** — at time \(t\).
...
The **Dead** state is *absorbing* — once entered, individuals remain there.
...
<!-- In this lab, you’ll explore how **disturbance and regrowth** interact to shape long-term forest dynamics. -->
...
<!-- ### Part 1 — Exploring Logistic Growth at the Patch Scale {-} -->
...
<!-- - How does the logistic model’s upper limit \(K\) control long-term behavior? -->
<!-- ::: -->

<!-- --- -->

<!-- ### Part 2 — Introducing Disturbance {-} -->

<!-- 1. Set **disturbance probability = 0.05**. -->
<!-- 2. Observe the **Grid View** as the simulation runs — patches of biomass reset randomly each year. -->
...
<!-- ### Part 3 — Adjusting Regrowth After Fire {-} -->
...
<!-- ### Part 4 — Total Biomass Over Time {-} -->

<!-- 1. Open the **“Total Biomass”** tab. -->
<!-- 2. Run the simulation for **200–250 years** to observe how biomass fluctuates over long time spans. -->
...
<!-- 2. Set **replicates = 20** and click **“Run Monte Carlo Simulation.”** -->
...
<!-- ### Part 6 — Exploring Disturbance Frequency {-} -->

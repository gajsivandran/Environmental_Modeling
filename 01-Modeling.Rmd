...
- **Fri**: Begin working in RStudio! We'll introduce the platform, walk through a tutorial, and use an LLM to help you write your first line of R code. This day is all about taking that first step—together.
...
Go the the following link to download RStudio
...
<iframe width="560" height="315"
  src="https://www.youtube.com/embed/BvKETZ6kr9Q"
...
[![Climate Model Thumbnail](https://i.gifer.com/9uje.gif)](https://science.nasa.gov/earth/climate-change/study-confirms-climate-models-are-getting-future-warming-projections-right/)


## Let's Build a Model of Learning

This is the way I see your learning. It's a simple feedback between coming to class and office hours.

<iframe width="500" height="440" frameborder="0" src="https://ncase.me/loopy/v1.1/?embed=1&data=[[[1,429,343,0,%22Learning%22,4],[2,191,211,0,%22Come%2520to%2520Class%22,5],[3,638,186,0,%22Office%2520Hours%22,0],[4,647,518,0,%22Happiness%22,3]],[[2,1,94,1,0],[1,2,89,1,0],[3,1,80,1,0],[1,3,81,1,0],[1,4,45,1,0]],[],4%5D"></iframe>
...
<iframe width="500" height="440" frameborder="0" src="https://ncase.me/loopy/v1.1/?embed=1&data=[[[6,504,144,0,%22Learning%2520%22,5],[7,507,347,0,%22Enjoyment%22,5],[8,505,553,0,%22Science%22,5],[9,201,129,0,%22%253F%22,3],[12,786,133,0,%22%253F%22,0]],[[7,8,13,1,0],[6,7,-6,1,0],[9,6,18,1,0],[12,6,10,-1,0]],[[258,61,%22Thing%2520that%2520ADD%2520to%2520these%2520nodes%22],[775,67,%22Things%2520that%2520SUBTRACT%2520from%2520these%2520nodes%22]],12%5D"></iframe>
...
Learning increases Enjoyment, which in turn increases Science.
...
**Task**
This is the first model of the course—and it’s about you. Your task:
...
## What Is Systems Thinking and Simulation?
...
## Abstraction—and Why Is It So Hard?
...
<img src="C:\Users\gajan\OneDrive - UW\UW\Courses\497 - Simulation\Textbook_Project\bookdown_497_simulation\bookdown-demo_files\figure-html\Problem_solving.png" width="60%" style="display: block; margin: auto;" />
...
|--------------|-------------|
| `Plant`      | Identifier for the individual plant (Qn or Mn, where Q = Quebec, M = Mississippi) |
| `Type`       | Origin of the plant: `"Quebec"` or `"Mississippi"` |
| `Treatment`  | `"chilled"` or `"nonchilled"` (i.e., whether the plant was cooled) |
| `conc`       | CO₂ concentration in the ambient air (in mL/L) |
| `uptake`     | Rate of CO₂ uptake (μmol/m²/s) – this is the *response variable* |
